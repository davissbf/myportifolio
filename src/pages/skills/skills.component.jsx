      ...
      <CardDeck>
        <Row className="d-flex justify-content-around">
          ...
          <Col md={4}>
            ...
            <Card className="focus mt-2 mb-2 ">
              <Card.Body>
                <Card.Title className="text-center  card-title">Courses and certifieds</Card.Title>
                <hr />
                <Card.Text className="card-text d-flex justify-content-start flex-column">
                  {skills.courses.map((skill, index) => (
                    <span className="p-2" key={index}>
                      <a className="text-dark text-decoration-none" href={skill.link} target="_blank" rel="noopener noreferrer">
                        <Image src={skill.imgSrc} alt={skill.imgAltText} rounded className="image-style m-1"></Image> {skill.skillName}
                      </a>
          ...
          <Col md={4}>
            ...
            <Card className="focus mt-2 mb-2">
              <Card.Body>
                <Card.Title className="text-center  card-title">Container</Card.Title>
                <hr />
                <Card.Text className="card-text d-flex justify-content-start flex-column">
                  <span className="p-2">
                    <a className="text-dark text-decoration-none" href={skills.container[0].link} target="_blank" rel="noopener noreferrer">
                      <Image src={skills.container[0].imgSrc} alt={skills.container[0].imgAltText} rounded className="image-style m-1"></Image> {skills.container[0].skillName}
                    </a>
                  </span>
                </Card.Text>
              </Card.Body>
